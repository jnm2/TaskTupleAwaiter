...
#region (Task<T1>)
	...
	public static ConfiguredTaskAwaitable<T1> ConfigureAwait<T1>(
		...
		public static TupleTaskAwaiter<T1, T2> GetAwaiter<T1, T2>(
...
public struct TupleTaskAwaiter<T1, T2> : ICriticalNotifyCompletion
{
	...
	public (T1, T2) GetResult()
	{
		...
		public static TupleConfiguredTaskAwaitable<T1, T2>
			ConfigureAwait<T1, T2>(this (Task<T1>, Task<T2>) tasks,
				bool continueOnCapturedContext) =>
			new TupleConfiguredTaskAwaitable<T1, T2>(tasks,
...
public struct TupleConfiguredTaskAwaitable<T1, T2>
{
	...
	public TupleConfiguredTaskAwaitable((Task<T1>, Task<T2>) tasks,
		bool continueOnCapturedContext)
	{
		_tasks = tasks;
	...
	public struct Awaiter : ICriticalNotifyCompletion
	{
		...
		public Awaiter((Task<T1>, Task<T2>) tasks,
			bool continueOnCapturedContext)
		{
			_tasks = tasks;
			_whenAllAwaiter = Task.WhenAll(_tasks.Item1, _tasks.Item2)
...
public struct TupleConfiguredTaskAwaitable<T1, T2, T3>
{
	...
	public struct Awaiter : ICriticalNotifyCompletion
	{
		...
		{
			_tasks = tasks;
			_whenAllAwaiter = Task.WhenAll(_tasks.Item1, _tasks.Item2, _tasks.Item3)
				.ConfigureAwait(continueOnCapturedContext).GetAwaiter();
		}
...
public struct TupleTaskAwaiter<T1, T2, T3, T4> : ICriticalNotifyCompletion
{
	...
	public (T1, T2, T3, T4) GetResult()
	{
		...
		public static TupleConfiguredTaskAwaitable<T1, T2, T3, T4>
			ConfigureAwait<T1, T2, T3, T4>(this (Task<T1>, Task<T2>, Task<T3>, Task<T4>) tasks,
				bool continueOnCapturedContext) =>
...
public struct TupleConfiguredTaskAwaitable<T1, T2, T3, T4>
{
	...
	public struct Awaiter : ICriticalNotifyCompletion
	{
		...
		{
			_tasks = tasks;
			_whenAllAwaiter = Task.WhenAll(_tasks.Item1, _tasks.Item2, _tasks.Item3, _tasks.Item4)
				.ConfigureAwait(continueOnCapturedContext).GetAwaiter();
		}
...
public struct TupleTaskAwaiter<T1, T2, T3, T4, T5> : ICriticalNotifyCompletion
{
	...
	public (T1, T2, T3, T4, T5) GetResult()
	{
		...
		public static TupleConfiguredTaskAwaitable<T1, T2, T3, T4, T5>
			ConfigureAwait<T1, T2, T3, T4, T5>(this (Task<T1>, Task<T2>, Task<T3>, Task<T4>, Task<T5>) tasks,
				bool continueOnCapturedContext) =>
...
public struct TupleConfiguredTaskAwaitable<T1, T2, T3, T4, T5>
{
	...
	public struct Awaiter : ICriticalNotifyCompletion
	{
		...
		{
			_tasks = tasks;
			_whenAllAwaiter = Task.WhenAll(_tasks.Item1, _tasks.Item2, _tasks.Item3, _tasks.Item4, _tasks.Item5)
				.ConfigureAwait(continueOnCapturedContext).GetAwaiter();
		}
...
public struct TupleTaskAwaiter<T1, T2, T3, T4, T5, T6> : ICriticalNotifyCompletion
{
	...
	{
		_tasks = tasks;
		_whenAllAwaiter = Task.WhenAll(tasks.Item1, tasks.Item2, tasks.Item3, tasks.Item4, tasks.Item5, tasks.Item6)
			.GetAwaiter();
	}
	...
	public (T1, T2, T3, T4, T5, T6) GetResult()
	{
		...
		public static TupleConfiguredTaskAwaitable<T1, T2, T3, T4, T5, T6>
			ConfigureAwait<T1, T2, T3, T4, T5, T6>(this (Task<T1>, Task<T2>, Task<T3>, Task<T4>, Task<T5>, Task<T6>) tasks,
				bool continueOnCapturedContext) =>
...
public struct TupleConfiguredTaskAwaitable<T1, T2, T3, T4, T5, T6>
{
	...
	public struct Awaiter : ICriticalNotifyCompletion
	{
		...
		{
			_tasks = tasks;
			_whenAllAwaiter = Task.WhenAll(_tasks.Item1, _tasks.Item2, _tasks.Item3, _tasks.Item4, _tasks.Item5, _tasks.Item6)
				.ConfigureAwait(continueOnCapturedContext).GetAwaiter();
		}
...
#region (Task<T1>..Task<T7>)
		...
		public static TupleTaskAwaiter<T1, T2, T3, T4, T5, T6, T7> GetAwaiter<T1, T2, T3, T4, T5, T6, T7>(
					...
					new TupleTaskAwaiter<T1, T2, T3, T4, T5, T6, T7>(tasks);
...
public struct TupleTaskAwaiter<T1, T2, T3, T4, T5, T6, T7> : ICriticalNotifyCompletion
{
	...
	{
		_tasks = tasks;
		_whenAllAwaiter = Task.WhenAll(tasks.Item1, tasks.Item2, tasks.Item3, tasks.Item4, tasks.Item5, tasks.Item6, tasks.Item7)
			.GetAwaiter();
	}
	...
	public (T1, T2, T3, T4, T5, T6, T7) GetResult()
	{
		...
		public static TupleConfiguredTaskAwaitable<T1, T2, T3, T4, T5, T6, T7>
			ConfigureAwait<T1, T2, T3, T4, T5, T6, T7>(this (Task<T1>, Task<T2>, Task<T3>, Task<T4>, Task<T5>, Task<T6>, Task<T7>) tasks,
				bool continueOnCapturedContext) =>
...
public struct TupleConfiguredTaskAwaitable<T1, T2, T3, T4, T5, T6, T7>
{
	...
	public TupleConfiguredTaskAwaitable((Task<T1>, Task<T2>, Task<T3>, Task<T4>, Task<T5>, Task<T6>, Task<T7>) tasks,
		bool continueOnCapturedContext)
	{
		_tasks = tasks;
		_continueOnCapturedContext = continueOnCapturedContext;
	...
	public struct Awaiter : ICriticalNotifyCompletion
	{
		...
		{
			_tasks = tasks;
			_whenAllAwaiter = Task.WhenAll(_tasks.Item1, _tasks.Item2, _tasks.Item3, _tasks.Item4, _tasks.Item5, _tasks.Item6, _tasks.Item7)
				.ConfigureAwait(continueOnCapturedContext).GetAwaiter();
		}
...
public struct TupleTaskAwaiter<T1, T2, T3, T4, T5, T6, T7, T8> : ICriticalNotifyCompletion
{
	...
	{
		_tasks = tasks;
		_whenAllAwaiter = Task.WhenAll(tasks.Item1, tasks.Item2, tasks.Item3, tasks.Item4, tasks.Item5, tasks.Item6, tasks.Item7, tasks.Item8)
			.GetAwaiter();
	}
	...
	public (T1, T2, T3, T4, T5, T6, T7, T8) GetResult()
	{
		...
		public static TupleConfiguredTaskAwaitable<T1, T2, T3, T4, T5, T6, T7, T8>
			ConfigureAwait<T1, T2, T3, T4, T5, T6, T7, T8>(this (Task<T1>, Task<T2>, Task<T3>, Task<T4>, Task<T5>, Task<T6>, Task<T7>, Task<T8>) tasks,
				bool continueOnCapturedContext) =>
...
public struct TupleConfiguredTaskAwaitable<T1, T2, T3, T4, T5, T6, T7, T8>
{
	...
	public TupleConfiguredTaskAwaitable((Task<T1>, Task<T2>, Task<T3>, Task<T4>, Task<T5>, Task<T6>, Task<T7>, Task<T8>) tasks,
		bool continueOnCapturedContext)
	{
		_tasks = tasks;
		_continueOnCapturedContext = continueOnCapturedContext;
	...
	public struct Awaiter : ICriticalNotifyCompletion
	{
		...
		{
			_tasks = tasks;
			_whenAllAwaiter = Task.WhenAll(_tasks.Item1, _tasks.Item2, _tasks.Item3, _tasks.Item4, _tasks.Item5, _tasks.Item6, _tasks.Item7, _tasks.Item8)
				.ConfigureAwait(continueOnCapturedContext).GetAwaiter();
		}
...
public struct TupleTaskAwaiter<T1, T2, T3, T4, T5, T6, T7, T8, T9> : ICriticalNotifyCompletion
{
	...
	{
		_tasks = tasks;
		_whenAllAwaiter = Task.WhenAll(tasks.Item1, tasks.Item2, tasks.Item3, tasks.Item4, tasks.Item5, tasks.Item6, tasks.Item7, tasks.Item8, tasks.Item9)
			.GetAwaiter();
	}
	...
	public (T1, T2, T3, T4, T5, T6, T7, T8, T9) GetResult()
	{
		...
		public static TupleConfiguredTaskAwaitable<T1, T2, T3, T4, T5, T6, T7, T8, T9>
			ConfigureAwait<T1, T2, T3, T4, T5, T6, T7, T8, T9>(this (Task<T1>, Task<T2>, Task<T3>, Task<T4>, Task<T5>, Task<T6>, Task<T7>, Task<T8>, Task<T9>) tasks,
				bool continueOnCapturedContext) =>
...
public struct TupleConfiguredTaskAwaitable<T1, T2, T3, T4, T5, T6, T7, T8, T9>
{
	...
	public TupleConfiguredTaskAwaitable((Task<T1>, Task<T2>, Task<T3>, Task<T4>, Task<T5>, Task<T6>, Task<T7>, Task<T8>, Task<T9>) tasks,
		bool continueOnCapturedContext)
	{
		_tasks = tasks;
		_continueOnCapturedContext = continueOnCapturedContext;
	...
	public struct Awaiter : ICriticalNotifyCompletion
	{
		...
		public Awaiter((Task<T1>, Task<T2>, Task<T3>, Task<T4>, Task<T5>, Task<T6>, Task<T7>, Task<T8>, Task<T9>) tasks,
			bool continueOnCapturedContext)
		{
			_tasks = tasks;
			_whenAllAwaiter = Task.WhenAll(_tasks.Item1, _tasks.Item2, _tasks.Item3, _tasks.Item4, _tasks.Item5, _tasks.Item6, _tasks.Item7, _tasks.Item8, _tasks.Item9)
				.ConfigureAwait(continueOnCapturedContext).GetAwaiter();
		}
...
#endregion (Task<T1>..Task<T9>)
#region (Task<T1>..Task<T10>)

		public static TupleTaskAwaiter<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> GetAwaiter<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
...
public struct TupleTaskAwaiter<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : ICriticalNotifyCompletion
{
	...
	{
		_tasks = tasks;
		_whenAllAwaiter = Task.WhenAll(tasks.Item1, tasks.Item2, tasks.Item3, tasks.Item4, tasks.Item5, tasks.Item6, tasks.Item7, tasks.Item8, tasks.Item9, tasks.Item10)
			.GetAwaiter();
	}
	...
	public (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10) GetResult()
	{
		...
		public static TupleConfiguredTaskAwaitable<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
			ConfigureAwait<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(this (Task<T1>, Task<T2>, Task<T3>, Task<T4>, Task<T5>, Task<T6>, Task<T7>, Task<T8>, Task<T9>, Task<T10>) tasks,
				bool continueOnCapturedContext) =>
			new TupleConfiguredTaskAwaitable<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(tasks,
				continueOnCapturedContext);
...
public struct TupleConfiguredTaskAwaitable<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
{
	...
	public TupleConfiguredTaskAwaitable((Task<T1>, Task<T2>, Task<T3>, Task<T4>, Task<T5>, Task<T6>, Task<T7>, Task<T8>, Task<T9>, Task<T10>) tasks,
		bool continueOnCapturedContext)
	{
		_tasks = tasks;
		_continueOnCapturedContext = continueOnCapturedContext;
	...
	public struct Awaiter : ICriticalNotifyCompletion
	{
		...
		public Awaiter((Task<T1>, Task<T2>, Task<T3>, Task<T4>, Task<T5>, Task<T6>, Task<T7>, Task<T8>, Task<T9>, Task<T10>) tasks,
			bool continueOnCapturedContext)
		{
			_tasks = tasks;
			_whenAllAwaiter = Task.WhenAll(_tasks.Item1, _tasks.Item2, _tasks.Item3, _tasks.Item4, _tasks.Item5, _tasks.Item6, _tasks.Item7, _tasks.Item8, _tasks.Item9, _tasks.Item10)
				.ConfigureAwait(continueOnCapturedContext).GetAwaiter();
		}
...
.ConfigureAwait(continueOnCapturedContext);
		...
		public static ConfiguredTaskAwaitable ConfigureAwait(this (Task, Task, Task, Task, Task, Task, Task, Task) tasks,
			bool continueOnCapturedContext) => Task
			.WhenAll(tasks.Item1, tasks.Item2, tasks.Item3, tasks.Item4, tasks.Item5, tasks.Item6, tasks.Item7, tasks.Item8)
.ConfigureAwait(continueOnCapturedContext);
		...
		public static ConfiguredTaskAwaitable ConfigureAwait(this (Task, Task, Task, Task, Task, Task, Task, Task, Task) tasks,
			bool continueOnCapturedContext) => Task
...
.ConfigureAwait(continueOnCapturedContext);
		...
		public static ConfiguredTaskAwaitable ConfigureAwait(this (Task, Task, Task, Task, Task, Task, Task, Task, Task, Task) tasks,
			bool continueOnCapturedContext) => Task
			.WhenAll(tasks.Item1, tasks.Item2, tasks.Item3, tasks.Item4, tasks.Item5, tasks.Item6, tasks.Item7, tasks.Item8, tasks.Item9, tasks.Item10)
.ConfigureAwait(continueOnCapturedContext);
#endregion Task
}}